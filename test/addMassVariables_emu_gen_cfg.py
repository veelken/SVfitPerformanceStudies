...
process.addMassVariables = cms.PSet(
    ...
    svFitMEM = cms.PSet(
        ...
        inputFileName_xSection_times_AccCorr = cms.string('TauAnalysis/SVfitMEM/data/svFitMEM_xSection_and_AccCorr_13TeV.root'),
        graphName_xSection = cms.string('graph_Xsection_woAcc_13TeV_leplep_vamp'),
        graphName_Acc = cms.string('graph_Acc_13TeV_leplep_vamp'),
        minAcc = cms.double(1.e-2),
        addLogM_powers = cms.vdouble(0., 5.),
        inputFileName_hadTauTF = cms.string(''),
        graphName_hadTauTF = cms.string(''),
