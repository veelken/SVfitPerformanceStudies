...
process.addMassVariables = cms.PSet(
    ...
    svFitMEM = cms.PSet(
        ...
        inputFileName_xSection_times_AccCorr = cms.string('TauAnalysis/SVfitMEM/data/svFitMEM_xSection_and_AccCorr_leplep.root'),
        graphName_xSection = cms.string('graph_Xsection_woAcc_leplep_vamp'),
        graphName_Acc = cms.string('graph_Acc_leplep_vamp'),
    ...
    outputFileName = cms.string('svFitStudyNtuple_emu_smeared.root')
)
