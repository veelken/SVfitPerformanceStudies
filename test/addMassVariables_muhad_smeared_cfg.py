...
process.addMassVariables = cms.PSet(
    ...
    svFitMEM = cms.PSet(
        ...
        inputFileName_xSection_times_AccCorr = cms.string('TauAnalysis/SVfitMEM/data/svFitMEM_xSection_and_AccCorr_lephad.root'),
        graphName_xSection = cms.string('graph_Xsection_woAcc_lephad_vamp'),
        graphName_Acc = cms.string('graph_Acc_lephad_vamp'),
    ...
    outputFileName = cms.string('svFitStudyNtuple_muhad_smeared.root')
)
