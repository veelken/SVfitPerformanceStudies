...
process.addMassVariables = cms.PSet(
    ...
    svFitMEM = cms.PSet(
        ...
        intMode = cms.string('vegas'),
        maxObjFunctionCalls = cms.uint32(20000),
        ##maxObjFunctionCalls = cms.uint32(100000),
        ##maxObjFunctionCalls = cms.uint32(10000),
    ...
    outputFileName = cms.string('svFitStudyNtuple_muhad_gen_jobIdJOB_ID.root')
)
