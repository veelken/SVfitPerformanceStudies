...
process.addMassVariables = cms.PSet(
    ...
    outputTreeName = cms.string('ntupleProducer/hadhad_smeared/SVfitStudyNtupleProducer'),

    leg1BranchName = cms.string("smearedHadTau1"),
    leg1minPt = cms.double(30.),
    leg1maxAbsEta = cms.double(2.5),

    leg2BranchName = cms.string("smearedHadTau2"),
    ...
    svFitMEM = cms.PSet(
        ...
        inputFileName_xSection_times_AccCorr = cms.string('TauAnalysis/SVfitMEM/data/svFitMEM_xSection_and_AccCorr_hadhad.root'),
        graphName_xSection = cms.string('graph_Xsection_woAcc_hadhad_vamp'),
        graphName_Acc = cms.string('graph_Acc_hadhad_vamp'),
    ...
    outputFileName = cms.string('svFitStudyNtuple_hadhad_smeared.root')
)
