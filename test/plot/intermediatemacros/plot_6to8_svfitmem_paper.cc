...
void plot_6to8_svfitmem_paper(){
  ...
  for(int i=0; i<ndir; i++){
	...
	if     (histname.find("ca")!=std::string::npos)          {vhmass.back()->SetLineStyle(6); vhmass.back()->SetLineColor(kGreen); }
			...
			|| histname.find("svfitmemtfk5")) {vhmass.back()->SetLineStyle(1); vhmass.back()->SetLineColor(kRed);}


	if( vdir[i]=="emu_smeared"){
		if( histname.find("_ca")!=std::string::npos || histname.find("_svFit")!=std::string::npos || histname.find("_svfitmemtfk0")!=std::string::npos || histname.find("_svfitmemtfk3")!=std::string::npos ){
		...
		if( histname.find("_ca")!=std::string::npos || histname.find("_svFit")!=std::string::npos || histname.find("_svfitmemtfk0")!=std::string::npos || histname.find("_svfitmemtfk4")!=std::string::npos ){
	...
	}if( vdir[i]=="hadhad_smeared"){                if( histname.find("_ca")!=std::string::npos || histname.find("_svFit")!=std::string::npos || histname.find("_svfitmemtfk0")!=std::string::npos || histname.find("_svfitmemtfk4")!=std::string::npos ){
