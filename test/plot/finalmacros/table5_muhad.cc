...
void table5_muhad(){
  ...
  TH1D * bh_mvis       = (TH1D*)file_bkg->Get("muhad_smeared_vismass_fine_bin");
  TH1D * bh_SVfitSA    = (TH1D*)file_bkg->Get("muhad_smeared_svFit_fine_bin");
  TH1D * bh_SVfitMEMk0 = (TH1D*)file_bkg->Get("muhad_smeared_svfitmemtfk0_fine_bin");
  TH1D * bh_SVfitMEMk  = (TH1D*)file_bkg->Get("muhad_smeared_svfitmemtfk4_fine_bin");
  TH1D * bh_SVfitCLAk0 = (TH1D*)file_bkg->Get("muhad_smeared_svfitclatfk0_fine_bin");
  TH1D * bh_SVfitCLAk  = (TH1D*)file_bkg->Get("muhad_smeared_svfitclatfk4_fine_bin");
  vector<TH1D*> vh_mvis;
  ...
  ofstream table5;
  table5.open("table5_muhad.txt");

  table5<< "\\begin{table}"<<endl;
  table5<< "\\begin{center}"<<endl;

    ///////////////////// latex table //////////////////
    table5<< "\\begin{tabular}{|l|ccc|ccc|}"<<endl;
    table5<< "\\hline"<<endl;
    table5<< "\\multicolumn{7}{|c|}{$\\tauh\\tauh$ decay channel} \\\\"<<endl;
    table5<< "\\hline"<<endl;
    table5<< "\\hline"<<endl;
    table5<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$m_{\\vis}$} & \\multicolumn{3}{c|}{SVfitSA} \\\\"<<endl;
    table5<< "\\cline{2-7}"<<endl;
    table5<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table5<< "\\hline"<<endl;
    
    table5<< "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table5<<"$\\quad m_{\\PHiggsps} = 200$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(0))<<"$ & $ "<< rounded(vh_mvis.at(0)->GetRMS()/AlternativeMedian(vh_mvis.at(0))) << "$ & $ " << rounded(100*ratio_mvis_M200) <<"\\pm"<<rounded(100*err_ratio_mvis_M200) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 300$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(1))<<"$ & $ "<< rounded(vh_mvis.at(1)->GetRMS()/AlternativeMedian(vh_mvis.at(1))) << "$ & $ " << rounded(100*ratio_mvis_M300) <<"\\pm"<<rounded(100*err_ratio_mvis_M300) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 500$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(2))<<"$ & $ "<< rounded(vh_mvis.at(2)->GetRMS()/AlternativeMedian(vh_mvis.at(2))) << "$ & $ " << rounded(100*ratio_mvis_M500) <<"\\pm"<<rounded(100*err_ratio_mvis_M500)<< 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 800$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(3))<<"$ & $ "<< rounded(vh_mvis.at(3)->GetRMS()/AlternativeMedian(vh_mvis.at(3))) << "$ & $ " << rounded(100*ratio_mvis_M800) <<"\\pm"<<rounded(100*err_ratio_mvis_M800) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 1200$~\\GeV  &  $"<<AlternativeMedian(vh_mvis.at(4))<<"$ & $ "<< rounded(vh_mvis.at(4)->GetRMS()/AlternativeMedian(vh_mvis.at(4))) << "$ & $ " << rounded(100*ratio_mvis_M1200) <<"\\pm"<<rounded(100*err_ratio_mvis_M1200) <<
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 1800$~\\GeV  &  $"<<AlternativeMedian(vh_mvis.at(5))<<"$ & $ "<< rounded(vh_mvis.at(5)->GetRMS()/AlternativeMedian(vh_mvis.at(5))) << "$ & $ " << rounded(100*ratio_mvis_M1800) <<"\\pm"<<rounded(100*err_ratio_mvis_M1800) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 2600$~\\GeV  &  $"<<AlternativeMedian(vh_mvis.at(6))<<"$ & $ "<< rounded(vh_mvis.at(6)->GetRMS()/AlternativeMedian(vh_mvis.at(6))) << "$ & $ " << rounded(100*ratio_mvis_M2600) <<"\\pm"<<rounded(100*err_ratio_mvis_M2600)<<
    ...
    table5<<"$\\PZ' \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl;
    table5<<"$\\quad m_{\\PZ'} = 2500$~\\GeV       &  $"<<AlternativeMedian(bh_mvis)<<"$ & $ "<< rounded(bh_mvis->GetRMS()/AlternativeMedian(bh_mvis))<< "$ & $ " << " - " <<
    ...
    table5<< "\\hline"<<endl;
    table5<< "\\hline"<<endl;
    table5<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$cSVfit, $\\kappa=0$$} & \\multicolumn{3}{c|}{cSVfit, $\\kappa=4$} \\\\"<<endl;
    table5<< "\\cline{2-7}"<<endl;
    table5<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table5<< "\\hline"<<endl;

    table5<< "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table5<<"$\\quad m_{\\PHiggsps} = 200$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(0))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(0)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(0))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M200) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M200) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 300$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(1))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(1)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(1))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M300) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M300) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 500$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(2))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(2)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(2))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M500) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M500)<< 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 800$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(3))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(3)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(3))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M800) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M800) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 1200$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(4))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(4)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(4))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M1200) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M1200) <<
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 1800$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(5))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(5)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(5))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M1800) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M1800) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 2600$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(6))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(6)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(6))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M2600) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M2600)<<
    ...
    table5<<"$\\PZ' \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl;
    table5<<"$\\quad m_{\\PZ'} = 2500$~\\GeV       &  $"<<AlternativeMedian(bh_SVfitCLAk0)<<"$ & $ "<< rounded(bh_SVfitCLAk0->GetRMS()/AlternativeMedian(bh_SVfitCLAk0))<< "$ & $ " << " - " <<
    ...
    table5<< "\\hline"<<endl;
    table5<< "\\hline"<<endl;
    table5<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$SVfitMEM, $\\kappa=0$$} & \\multicolumn{3}{c|}{SVfitMEM, $\\kappa=4$} \\\\"<<endl;
    table5<< "\\cline{2-7}"<<endl;
    table5<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table5<< "\\hline"<<endl;
    
    table5<< "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table5<<"$\\quad m_{\\PHiggsps} = 200$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(0))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(0)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(0))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M200) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M200) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 300$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(1))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(1)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(1))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M300) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M300) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 500$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(2))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(2)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(2))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M500) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M500)<< 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 800$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(3))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(3)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(3))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M800) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M800) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 1200$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(4))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(4)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(4))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M1200) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M1200) <<
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 1800$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(5))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(5)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(5))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M1800) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M1800) << 
    ...
    table5<<"$\\quad m_{\\PHiggsps} = 2600$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(6))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(6)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(6))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M2600) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M2600)<<
    ...
    table5<<"$\\PZ' \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl;
    table5<<"$\\quad m_{\\PZ'} = 2500$~\\GeV       &  $"<<AlternativeMedian(bh_SVfitMEMk0)<<"$ & $ "<< rounded(bh_SVfitMEMk0->GetRMS()/AlternativeMedian(bh_SVfitMEMk0))<< "$ & $ " << " - " <<
