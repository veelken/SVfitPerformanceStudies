...
void table3_emu()
{
  ...
  //-----------------------------------------------------------------------------
  // mVis and SVfitSA
  table3 << "\\begin{tabular}{|l|cccc|cccc|}" << endl;
  //table3 << "\\begin{tabular}{|l|C{1.2cm}C{0.9cm}C{0.9cm}C{1.2cm}|C{1.2cm}C{0.9cm}C{0.9cm}C{1.2cm}|}" << endl;
  table3 << "\\hline" << endl;
  table3 << "\\multicolumn{9}{|c|}{$\\Pe\\Pgm$ decay channel} \\\\" << endl;
  table3 << "\\hline" << endl;
  table3 << "\\hline" << endl;
  table3 << "\\multirow{2}{17mm}{Sample} & \\multicolumn{4}{c|}{$m_{\\vis}$} & \\multicolumn{4}{c|}{SVfitSA} \\\\" << endl;
  table3 << "\\cline{2-9}" << endl;
  table3 << " & " 
	 << "$\\textrm{M}$~[\\GeV\\unskip] & "
  ...
  addRow_wSoB(table3, "$1$-jet non--boosted", 
  ...
  addRow_wSoB(table3, "$1$-jet boosted", 
  ...
  //table3 << "\\begin{tabular}{|l|C{1.2cm}C{0.9cm}C{0.9cm}C{1.2cm}|C{1.2cm}C{0.9cm}C{0.9cm}C{1.2cm}|}" << endl;
  table3 << "\\hline" << endl;
  table3 << "\\multirow{2}{17mm}{Sample} & \\multicolumn{4}{c|}{cSVfit, $\\kappa=0$} & \\multicolumn{4}{c|}{cSVfit, $\\kappa=3$} \\\\" << endl;
  table3 << "\\cline{2-9}" << endl;
  table3 << " & " 
	 << "$\\textrm{M}$~[\\GeV\\unskip] & "
	 << "$\\sigma_{l}/\\textrm{M}$ & $\\sigma_{h}/\\textrm{M}$ & " 
  ...
  //table3 << "\\begin{tabular}{|l|C{1.2cm}C{0.9cm}C{0.9cm}C{1.2cm}|C{1.2cm}C{0.9cm}C{0.9cm}C{1.2cm}|}" << endl;
  table3 << "\\hline" << endl;
  table3 << "\\multirow{2}{17mm}{Sample} & \\multicolumn{4}{c|}{SVfitMEM, $\\kappa=0$} & \\multicolumn{4}{c|}{SVfitMEM, $\\kappa=3$} \\\\" << endl;
  table3 << "\\cline{2-9}" << endl;
  table3 << " & " 
	 << "$\\textrm{M}$~[\\GeV\\unskip] & "
	 << "$\\sigma_{l}/\\textrm{M}$ & $\\sigma_{h}/\\textrm{M}$ & " 
