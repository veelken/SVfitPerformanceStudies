...
void makeSVfitMEM_massPlots_from10to12()
{
  gROOT->SetBatch(true);
  ...
  inputFileNames_emu[200]     = "plot_10to12_log_emu_smeared.root";
  inputFileNames_emu[300]     = "plot_10to12_log_emu_smeared.root";
  inputFileNames_emu[500]     = "plot_10to12_log_emu_smeared.root";
  inputFileNames_emu[800]     = "plot_10to12_log_emu_smeared.root";
  inputFileNames_emu[1200]    = "plot_10to12_log_emu_smeared.root";
  std::map<int, std::string> inputFileNames_muhad; // key = massPoint
  inputFileNames_muhad[200]   = "plot_10to12_log_muhad_smeared.root";
  inputFileNames_muhad[300]   = "plot_10to12_log_muhad_smeared.root";
  inputFileNames_muhad[500]   = "plot_10to12_log_muhad_smeared.root";
  inputFileNames_muhad[800]   = "plot_10to12_log_muhad_smeared.root";
  inputFileNames_muhad[1200]  = "plot_10to12_log_muhad_smeared.root";
  std::map<int, std::string> inputFileNames_hadhad; // key = massPoint
  inputFileNames_hadhad[200]  = "plot_10to12_log_hadhad_smeared.root";
  inputFileNames_hadhad[300]  = "plot_10to12_log_hadhad_smeared.root";
  inputFileNames_hadhad[500]  = "plot_10to12_log_hadhad_smeared.root";
  inputFileNames_hadhad[800]  = "plot_10to12_log_hadhad_smeared.root";
  inputFileNames_hadhad[1200] = "plot_10to12_log_hadhad_smeared.root";
  ...
  outputFileNames_emu[1200]    = "makeSVfitMEM_PerformancePlots_HiggsSUSYGluGlu1200_emu_log.pdf";
  ...
  outputFileNames_muhad[1200]  = "makeSVfitMEM_PerformancePlots_HiggsSUSYGluGlu1200_muhad_log.pdf";
  ...
  outputFileNames_hadhad[1200] = "makeSVfitMEM_PerformancePlots_HiggsSUSYGluGlu1200_hadhad_log.pdf";
