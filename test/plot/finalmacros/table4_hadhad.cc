...
void table4_hadhad(){
  ...
  table4 << "\\begin{center}" << endl;
    ...
    ///////////////////// latex table //////////////////
    table4 << "\\begin{tabular}{|l|C{1.5cm}C{1.5cm}|C{1.5cm}C{1.5cm}|}" << endl;
    table4 << "\\hline" << endl;
    table4 << "\\multicolumn{5}{|c|}{$\\tauh\\tauh$ decay channel} \\\\" << endl;
    table4 << "\\hline" << endl;
    table4 << "\\hline" << endl;
    table4 << "\\multirow{2}{17mm}{Sample} & \\multicolumn{2}{c|}{$m_{\\vis}$} & \\multicolumn{2}{c|}{SVfitSA} \\\\" << endl;
    table4 << "\\cline{2-5}" << endl;
    table4 << " & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ \\\\" << endl;
    table4 << "\\hline" << endl;
    
    table4 << "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & \\\\ "<<endl; 
    table4 << "$\\quad m_{\\PHiggsps} = 200$~\\GeV  & $" 
    ...
    table4 << "$\\quad m_{\\PHiggsps} = 300$~\\GeV  & $"
    ...
    table4 << "$\\quad m_{\\PHiggsps} = 500$~\\GeV  & $"
    ...
    table4 << "$\\quad m_{\\PHiggsps} = 800$~\\GeV  & $"
    ...
    table4 << "$\\quad m_{\\PHiggsps} = 1200$~\\GeV & $"
    ...
    table4 << "$\\quad m_{\\PHiggsps} = 1800$~\\GeV & $"
    ...
    table4 << "$\\quad m_{\\PHiggsps} = 2600$~\\GeV & $"
    ...
    table4 << "\\hline" << endl;
    table4 << "\\end{tabular}" << endl;
    table4 << endl;
    table4 << "\\begin{tabular}{|l|C{1.5cm}C{1.5cm}|C{1.5cm}C{1.5cm}|}" << endl;
    table4 << "\\hline" << endl;
    table4 << "\\multirow{2}{17mm}{Sample} & \\multicolumn{2}{c|}{cSVfit, $\\kappa=0$} & \\multicolumn{2}{c|}{cSVfit, $\\kappa=5$} \\\\" << endl;
    table4 << "\\cline{2-5}" << endl;
    table4 << " & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ \\\\" << endl;
    table4 << "\\hline" << endl;
    ...
    table4 << "\\begin{tabular}{|l|C{1.5cm}C{1.5cm}|C{1.5cm}C{1.5cm}|}" << endl;
    table4 << "\\hline" << endl;
    table4 << "\\multirow{2}{17mm}{Sample} & \\multicolumn{2}{c|}{SVfitMEM, $\\kappa=0$} & \\multicolumn{2}{c|}{SVfitMEM, $\\kappa=5$} \\\\" << endl;
    table4 << "\\cline{2-5}" << endl;
    table4 << " & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ \\\\" << endl;
    table4 << "\\hline" << endl;
    ...
    table4 << "\\hline" << endl;
    table4 << "\\end{tabular}" << endl;
    table4 << "\\end{center}" << endl;
    //table4 << "\\end{table}" << endl;
