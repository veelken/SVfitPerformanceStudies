...
void table6_emu(){
  ...
  TH1D * bh_mvis       = (TH1D*)file_bkg->Get("emu_smeared_vismass_fine_bin");
  TH1D * bh_SVfitSA    = (TH1D*)file_bkg->Get("emu_smeared_svFit_fine_bin");
  TH1D * bh_SVfitMEMk0 = (TH1D*)file_bkg->Get("emu_smeared_svfitmemtfk0_fine_bin");
  TH1D * bh_SVfitMEMk  = (TH1D*)file_bkg->Get("emu_smeared_svfitmemtfk3_fine_bin");
  TH1D * bh_SVfitCLAk0 = (TH1D*)file_bkg->Get("emu_smeared_svfitclatfk0_fine_bin");
  TH1D * bh_SVfitCLAk  = (TH1D*)file_bkg->Get("emu_smeared_svfitclatfk3_fine_bin");
  vector<TH1D*> vh_mvis;
  ...
  table6<< "\\begin{center}"<<endl;
    ...
    ///////////////////// latex table //////////////////
    table6<< "\\begin{tabular}{|l|ccc|ccc|}"<<endl;
    table6<< "\\hline"<<endl;
    table6<< "\\multicolumn{7}{|c|}{$\\tauh\\tauh$ decay channel} \\\\"<<endl;
    table6<< "\\hline"<<endl;
    table6<< "\\hline"<<endl;
    table6<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$m_{\\vis}$} & \\multicolumn{3}{c|}{SVfitSA} \\\\"<<endl;
    table6<< "\\cline{2-7}"<<endl;
    table6<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table6<< "\\hline"<<endl;
    
    table6<< "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table6<<"$\\quad m_{\\PHiggsps} = 200$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(0))<<"$ & $ "<< rounded(vh_mvis.at(0)->GetRMS()/AlternativeMedian(vh_mvis.at(0))) << "$ & $ " << rounded(100*ratio_mvis_M200) <<"\\pm"<<rounded(100*err_ratio_mvis_M200) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 300$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(1))<<"$ & $ "<< rounded(vh_mvis.at(1)->GetRMS()/AlternativeMedian(vh_mvis.at(1))) << "$ & $ " << rounded(100*ratio_mvis_M300) <<"\\pm"<<rounded(100*err_ratio_mvis_M300) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 500$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(2))<<"$ & $ "<< rounded(vh_mvis.at(2)->GetRMS()/AlternativeMedian(vh_mvis.at(2))) << "$ & $ " << rounded(100*ratio_mvis_M500) <<"\\pm"<<rounded(100*err_ratio_mvis_M500)<< 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 800$~\\GeV   &  $"<<AlternativeMedian(vh_mvis.at(3))<<"$ & $ "<< rounded(vh_mvis.at(3)->GetRMS()/AlternativeMedian(vh_mvis.at(3))) << "$ & $ " << rounded(100*ratio_mvis_M800) <<"\\pm"<<rounded(100*err_ratio_mvis_M800) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 1200$~\\GeV  &  $"<<AlternativeMedian(vh_mvis.at(4))<<"$ & $ "<< rounded(vh_mvis.at(4)->GetRMS()/AlternativeMedian(vh_mvis.at(4))) << "$ & $ " << rounded(100*ratio_mvis_M1200) <<"\\pm"<<rounded(100*err_ratio_mvis_M1200) <<
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 1800$~\\GeV  &  $"<<AlternativeMedian(vh_mvis.at(5))<<"$ & $ "<< rounded(vh_mvis.at(5)->GetRMS()/AlternativeMedian(vh_mvis.at(5))) << "$ & $ " << rounded(100*ratio_mvis_M1800) <<"\\pm"<<rounded(100*err_ratio_mvis_M1800) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 2600$~\\GeV  &  $"<<AlternativeMedian(vh_mvis.at(6))<<"$ & $ "<< rounded(vh_mvis.at(6)->GetRMS()/AlternativeMedian(vh_mvis.at(6))) << "$ & $ " << rounded(100*ratio_mvis_M2600) <<"\\pm"<<rounded(100*err_ratio_mvis_M2600)<<
    ...
    table6<<"$\\quad m_{\\PZ'} = 2500$~\\GeV       &  $"<<AlternativeMedian(bh_mvis)<<"$ & $ "<< rounded(bh_mvis->GetRMS()/AlternativeMedian(bh_mvis))<< "$ & $ " << " - " <<
    ...
    table6<< "\\hline"<<endl;
    table6<< "\\hline"<<endl;
    table6<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$cSVfit, $\\kappa=0$$} & \\multicolumn{3}{c|}{cSVfit, $\\kappa=3$} \\\\"<<endl;
    table6<< "\\cline{2-7}"<<endl;
    table6<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table6<< "\\hline"<<endl;

    table6<< "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table6<<"$\\quad m_{\\PHiggsps} = 200$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(0))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(0)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(0))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M200) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M200) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 300$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(1))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(1)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(1))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M300) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M300) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 500$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(2))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(2)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(2))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M500) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M500)<< 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 800$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(3))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(3)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(3))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M800) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M800) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 1200$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(4))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(4)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(4))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M1200) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M1200) <<
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 1800$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(5))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(5)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(5))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M1800) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M1800) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 2600$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(6))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(6)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(6))) << "$ & $ " << rounded(100*ratio_SVfitCLAk0_M2600) <<"\\pm"<<rounded(100*err_ratio_SVfitCLAk0_M2600)<<
    ...
    table6<<"$\\PZ' \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl;
    table6<<"$\\quad m_{\\PZ'} = 2500$~\\GeV       &  $"<<AlternativeMedian(bh_SVfitCLAk0)<<"$ & $ "<< rounded(bh_SVfitCLAk0->GetRMS()/AlternativeMedian(bh_SVfitCLAk0))<< "$ & $ " << " - " <<
    ...
    table6<< "\\hline"<<endl;
    table6<< "\\hline"<<endl;
    table6<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$SVfitMEM, $\\kappa=0$$} & \\multicolumn{3}{c|}{SVfitMEM, $\\kappa=3$} \\\\"<<endl;
    table6<< "\\cline{2-7}"<<endl;
    table6<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table6<< "\\hline"<<endl;
    
    table6<< "$\\PHiggsps \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table6<<"$\\quad m_{\\PHiggsps} = 200$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(0))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(0)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(0))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M200) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M200) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 300$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(1))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(1)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(1))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M300) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M300) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 500$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(2))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(2)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(2))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M500) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M500)<< 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 800$~\\GeV   &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(3))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(3)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(3))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M800) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M800) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 1200$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(4))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(4)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(4))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M1200) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M1200) <<
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 1800$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(5))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(5)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(5))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M1800) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M1800) << 
    ...
    table6<<"$\\quad m_{\\PHiggsps} = 2600$~\\GeV  &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(6))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(6)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(6))) << "$ & $ " << rounded(100*ratio_SVfitMEMk0_M2600) <<"\\pm"<<rounded(100*err_ratio_SVfitMEMk0_M2600)<<
    ...
    table6<<"$\\PZ' \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl;
    table6<<"$\\quad m_{\\PZ'} = 2500$~\\GeV       &  $"<<AlternativeMedian(bh_SVfitMEMk0)<<"$ & $ "<< rounded(bh_SVfitMEMk0->GetRMS()/AlternativeMedian(bh_SVfitMEMk0))<< "$ & $ " << " - " <<
