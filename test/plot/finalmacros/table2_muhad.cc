...
void table2_muhad(){
  ...
  table2<< "\\begin{center}"<<endl;
    ...
    ///////////////////// latex table //////////////////
    table2<< "\\begin{tabular}{|l|ccc|ccc|}"<<endl;
    table2<< "\\hline"<<endl;
    table2<< "\\multicolumn{7}{|c|}{$\\tauh\\tauh$ decay channel} \\\\"<<endl;
    table2<< "\\hline"<<endl;
    table2<< "\\hline"<<endl;
    table2<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$m_{\\vis}$} & \\multicolumn{3}{c|}{SVfitSA} \\\\"<<endl;
    table2<< "\\cline{2-7}"<<endl;
    table2<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table2<< "\\hline"<<endl;
    
    //Ztautau			    
    table2<< "$\\PZ \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table2<<"$\\quad$ $0$-jet              &  $"<<AlternativeMedian(vh_mvis.at(0))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $1$-jet non--boosted &  $"<<AlternativeMedian(vh_mvis.at(1))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $1$-jet boosted      &  $"<<AlternativeMedian(vh_mvis.at(2))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $2$-jet VBF          &  $"<<AlternativeMedian(vh_mvis.at(3))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $0$-jet              &  $"<<AlternativeMedian(vh_mvis.at(4))<<"$ & $ "<< rounded(vh_mvis.at(4)->GetRMS()/AlternativeMedian(vh_mvis.at(4))) << 
    ...
    table2<<"$\\quad$ $1$-jet non--boosted &  $"<<AlternativeMedian(vh_mvis.at(5))<<"$ & $ "<< rounded(vh_mvis.at(5)->GetRMS()/AlternativeMedian(vh_mvis.at(5))) << 
    ...
    table2<<"$\\quad$ $1$-jet boosted      &  $"<<AlternativeMedian(vh_mvis.at(6))<<"$ & $ "<< rounded(vh_mvis.at(6)->GetRMS()/AlternativeMedian(vh_mvis.at(6))) << 
    ...
    table2<<"$\\quad$ $2$-jet VBF          &  $"<<AlternativeMedian(vh_mvis.at(7))<<"$ & $ "<< rounded(vh_mvis.at(7)->GetRMS()/AlternativeMedian(vh_mvis.at(7))) << 
    ...
    table2<< "\\hline"<<endl;
    table2<< "\\hline"<<endl;
    table2<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$cSVfit, $\\kappa=0$$} & \\multicolumn{3}{c|}{cSVfit, $\\kappa=4$} \\\\"<<endl;
    table2<< "\\cline{2-7}"<<endl;
    table2<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table2<< "\\hline"<<endl;
    ...
    //Ztautau			    
    table2<< "$\\PZ \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table2<<"$\\quad$ $0$-jet              &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(0))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $1$-jet non--boosted &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(1))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $1$-jet boosted      &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(2))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $2$-jet VBF          &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(3))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $0$-jet              &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(4))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(4)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(4))) << 
    ...
    table2<<"$\\quad$ $1$-jet non--boosted &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(5))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(5)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(5))) << 
    ...
    table2<<"$\\quad$ $1$-jet boosted      &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(6))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(6)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(6))) << 
    ...
    //SM VBF		    
    table2<< "SM $\\Pquark\\APquark \\to \\PHiggs$, $\\PHiggs \\to \\Pgt\\Pgt$: & & & & & & "<<endl; 
    table2<<"$\\quad$ $2$-jet VBF          &  $"<<AlternativeMedian(vh_SVfitCLAk0.at(7))<<"$ & $ "<< rounded(vh_SVfitCLAk0.at(7)->GetRMS()/AlternativeMedian(vh_SVfitCLAk0.at(7))) << 
    ...
    table2<< "\\hline"<<endl;
    table2<< "\\hline"<<endl;
    table2<< "\\multirow{2}{17mm}{Sample} & \\multicolumn{3}{c|}{$SVfitMEM, $\\kappa=0$$} & \\multicolumn{3}{c|}{SVfitMEM, $\\kappa=4$} \\\\"<<endl;
    table2<< "\\cline{2-7}"<<endl;
    table2<< "& $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ & $\\textrm{M}$~[\\GeV\\unskip] & $\\sigma/\\textrm{M}$ & $S/\\sqrt{B}$ \\\\"<<endl;
    table2<< "\\hline"<<endl;
    ...
    //Ztautau			    
    table2<< "$\\PZ \\to \\Pgt\\Pgt$: & & & & & & \\\\ "<<endl; 
    table2<<"$\\quad$ $0$-jet              &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(0))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $1$-jet non--boosted &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(1))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $1$-jet boosted      &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(2))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $2$-jet VBF          &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(3))<<"$ & $ "<<
    ...
    table2<<"$\\quad$ $0$-jet              &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(4))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(4)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(4))) << 
    ...
    table2<<"$\\quad$ $1$-jet non--boosted &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(5))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(5)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(5))) << 
    ...
    table2<<"$\\quad$ $1$-jet boosted      &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(6))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(6)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(6))) << 
    ...
    //SM VBF		    
    table2<< "SM $\\Pquark\\APquark \\to \\PHiggs$, $\\PHiggs \\to \\Pgt\\Pgt$: & & & & & & "<<endl; 
    table2<<"$\\quad$ $2$-jet VBF          &  $"<<AlternativeMedian(vh_SVfitMEMk0.at(7))<<"$ & $ "<< rounded(vh_SVfitMEMk0.at(7)->GetRMS()/AlternativeMedian(vh_SVfitMEMk0.at(7))) << 
